...
const Navbar = () => {
    ...
    function handleClickers(e:SyntheticEvent) {
        console.log(e.type);
    }
    
    return (
        <nav>
            <aside onClick={(e: SyntheticEvent) => handleClickers(e) }>
                <svg id="hamburger" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" stroke="#0a0d02" strokeWidth=".6" fill="rgba(0,0,0,0)" strokeLinecap="round" style={ { cursor: "pointer" }}>
