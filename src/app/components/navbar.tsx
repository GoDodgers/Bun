import { ReactHTMLElement, SyntheticEvent } from "react";
    ...
    return (
        <nav>
            <aside onClick={(e: SyntheticEvent) => handleClickers(e) }>
                <svg id="hamburger" viewBox="0 0 18 15">
